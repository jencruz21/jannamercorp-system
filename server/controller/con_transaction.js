...
// remove this BS
// exports.totalSalesByItem = async (req, res) => {
//     try {
//         const result = await Transactiondb.aggregate([
//             { $match: {} },
//             { $group: { 
//                 _id: '$t_name', 
//                 total_income_by_retail: { $sum: '$t_grandTotal'},
//                 total_cavans_sold: { $sum: '$t_cavans'},
//                 total_items_sold: { $sum: '$t_items'}
//             } }
//         ]);
